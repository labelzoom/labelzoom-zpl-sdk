...
{
    public abstract class TargetBuilderBase: ITarget
    {
        protected readonly LabelzoomClient client;
        protected readonly string sourcePath;
        protected readonly Stream sourceStream;
        protected readonly string contentType;

        protected TargetBuilderBase(LabelzoomClient client, string sourcePath, string contentType)
        {
        ...
        protected TargetBuilderBase(LabelzoomClient client, Stream sourceStream, string contentType)
        {
            this.client = client ?? throw new ArgumentNullException(nameof(client));
